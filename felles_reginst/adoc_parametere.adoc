...
:uml-url: {umlbase-url}{datasett}/{prodspek-versjon}
:reginstr-url: {reginstrbase-url}{datasett}/{versjon}/{reginstr-type}_{underversjon}
:reginstr-url-ny: {reginstrbase-url}{datasett}/{versjon}/{reginstr-type}_{erstattet-av}
:reginstr-url-erstatter: {reginstrbase-url}{datasett}/{versjon}/{reginstr-type}_{erstatter}