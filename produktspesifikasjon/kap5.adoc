// Start of UML-model
=== Pakke: «ApplicationSchema» Utkast-FKB-Veg-5.1
...
|designation
|"Product specification FKB-Veg 5.1"@en
...
|targetNamespace
|http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.1
...
|Profilparametre i tagged values: 
|
defaultCodeSpace: https://register.geonorge.no/sosi-kodelister/fkb/veg/5.0/vegkategori + 
SOSI_datatype: T + 
SOSI_lengde: 50 + 
...
|Profilparametre i tagged values: 
|
defaultCodeSpace: https://register.geonorge.no/sosi-kodelister/fkb/veg/5.0/vegfase + 
SOSI_datatype: T + 
SOSI_lengde: 20 + 
SOSI_navn: VEGFASE + 
|===
