...
image::figurer/vegflater.png[link=figurer/vegflater.png, Alt="Eksempel på registrering av sykkelveg og gangveg uten fysisk skille mellom seg (kun oppmerking)."]
